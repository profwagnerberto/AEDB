    ...
    switch(opcao){
      ...
      case 6:
        ...
        if (alunoRetornado == NULL) {
          ...
          printf(" * \n A idade do aluno %s foi encontrada na coluna %d. \n",alunoRetornado->primeiroNome,endereco);
        }
        printf(" * \n * \n * \n");
        break;
      case 7:
